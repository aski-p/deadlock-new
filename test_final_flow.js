...
async function testCompleteFlow() {
  ...
  const getItemImage = (itemName) => {
    const itemImageMap = {
      ...
      'Sharpshooter': 'https://cdn.deadlock.coach/vpk/panorama/images/items/weapon/headshot_booster.webp', // Fixed
      ...
      'Bullet Armor': 'https://cdn.deadlock.coach/vpk/panorama/images/items/vitality/extra_health.webp', // Fixed
      'Improved Bullet Armor': 'https://cdn.deadlock.coach/vpk/panorama/images/items/vitality/metal_skin.webp', // Fixed
      ...
      'Spirit Armor': 'https://cdn.deadlock.coach/vpk/panorama/images/items/vitality/spirit_lifesteal.webp', // Fixed
      'Improved Spirit Armor': 'https://cdn.deadlock.coach/vpk/panorama/images/items/vitality/metal_skin.webp', // Fixed
  ...
  for (const heroName of testHeroes) {
    ...
    selectedItems.forEach(item => {
      ...
      const isDefault = imageUrl === 'https://cdn.deadlock.coach/vpk/panorama/images/items/weapon/basic_magazine.webp';
      const status = isDefault ? '❌' : '✅';
      if (isDefault) allWorking = false;
      console.log(`    ${status} ${item.name} (${item.category})`);
    });
    
    console.log(`    ${allWorking ? '✅' : '⚠️'} All items ${allWorking ? 'mapped correctly' : 'have fallbacks'}\n`);
  }
